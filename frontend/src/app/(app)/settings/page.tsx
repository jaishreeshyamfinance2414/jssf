...
export default function SettingsPage() {
  return (
    <PageShell title="Settings" description="Business rules for processing fees, penalty, interest, and loan number format.">
      <Card>
        ...
        <CardContent className="grid gap-3 text-sm text-muted-foreground md:grid-cols-2">
          <div className="rounded-md border p-3">Processing fee: first loan 5%, subsequent 1%</div>
