...
export function downloadCollectionPdf(rows: PdfRow[], dateStr: string) {
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      ...
      9:  { halign: 'right', overflow: 'visible' },
      10: { halign: 'right', overflow: 'visible' },
      11: { halign: 'right', overflow: 'visible' },
      12: { halign: 'right', overflow: 'visible' },
      13: { halign: 'right', overflow: 'visible' },
      14: { halign: 'right', overflow: 'visible' },
    },
    theme: 'grid',
