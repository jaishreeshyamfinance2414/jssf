...
router.get('/backup/history', requireRole('admin'), asyncHandler(settingsController.getBackupHistory));
router.post('/backup/now', requireRole('admin'), requirePasskey(), asyncHandler(settingsController.backupNow));
