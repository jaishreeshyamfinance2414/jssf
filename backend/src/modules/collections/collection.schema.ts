...
export const updateCollectionSchema = z
  ...
  .refine(
    (v) => {
      ...
      if (v.type === 'missed') return (v.amount === undefined || v.amount === 0) && (v.penalty === undefined || v.penalty === 0);
      // Zero-value Full/Advance rows are generated by statement reconciliation
      // and remain editable by admins like every other collection entry.
